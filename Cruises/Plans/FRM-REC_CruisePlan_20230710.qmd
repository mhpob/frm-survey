---
title: 'Recreational Survey -- July 2023'
subtitle: "July 10-12, 2023   [*F/V Fin Chaser*](https://finchasersportfishing.com/)   Ocean City, MD"
format: html
editor: visual
echo: false
message: false
...
for(i in 1:2){
  ...
  survey_seq[[i]] <-
    data.table(start = trip[[i]]$station[1:(n_stations - 1)],
               end = trip[[i]]$station[2:n_stations],
...
-   [Dave Secor](mailto:secor@umces.edu)
-   [Kirsten Silva](mailto:ksilva@umces.edu)
-   [Todd Sumner](mailto:t.sumner@uswindinc.com)
-   [Dave Wilson](mailto:d.wilson@uswindinc.com)
...
-   Full crew (DS, KS, TS, DW, DS, DW mate)
...
leaflet() |> 
  ...
  addPolylines(data = st_sfc(
    st_cast(
      do.call(c, st_geometry(trip[[1]])),
      'LINESTRING'
    ), crs = 4326
  ), color = 'blue') |>
  addPolylines(data = st_sfc(
    st_cast(
      do.call(c, st_geometry(trip[[2]])),
      'LINESTRING'
    ), crs = 4326
  ), color = 'green') |> 
...
-   `r format(survey_seq[[2]]$endtime[1], '%H:%M')`: Arrive `r survey_seq[[2]]$end[1]`.
    -   Take pictures
-   `r format(survey_seq[[2]]$drop[1], '%H:%M')`: Depart for **`r survey_seq[[2]]$end[2]`**
...
-   `r format(survey_seq[[2]]$drop[2], '%H:%M')`: Drop survey ends. Transit to **`r survey_seq[[2]]$end[3]`**.
    -   <font size= "5"> **`r stations[stations$station == survey_seq[[2]]$end[3],]$lat_dm`, `r stations[stations$station == survey_seq[[2]]$end[3],]$lon_dm`** </font>
-   `r format(survey_seq[[2]]$endtime[3], '%H:%M')`: Arrive `r survey_seq[[2]]$end[3]`.
    -   Take pictures
-   `r format(survey_seq[[2]]$drop[3], '%H:%M')`: Depart for **`r survey_seq[[2]]$end[4]`**
    -   <font size= "5"> **`r stations[stations$station == survey_seq[[2]]$end[4],]$lat_dm`, `r stations[stations$station == survey_seq[[2]]$end[4],]$lon_dm`** </font>
-   `r format(survey_seq[[2]]$endtime[4], '%H:%M')`: Arrive `r survey_seq[[2]]$end[4]`.
-   `r format(survey_seq[[2]]$endtime[4] + 5*60, '%H:%M')`: Mate begins jigging.
-   `r format(survey_seq[[2]]$jig[4] - 5*60, '%H:%M')`: Mate ends jigging.
-   `r format(survey_seq[[2]]$jig[4], '%H:%M')`: Survey crew begins drop survey.
-   `r format(survey_seq[[2]]$drop[4], '%H:%M')`: Drop survey ends. Return to Talbot St Pier.
-   `r format(survey_seq[[2]]$endtime[5], '%H:%M')`: Arrive Talbot St Pier. Unload gear.
:::
:::
