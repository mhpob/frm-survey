...
params:
  ...
  seed: 20230626
  vessel_sp_kts: 8
  d1_start: '2023-06-27 02:30'
  d2_start: '2023-06-28 02:30'
---
...
-   [Dave Secor](mailto:secor@umces.edu): 301-481-5053
-   [Kirsten Silva](mailto:ksilva@umces.edu): 763-333-4860
-   Evan Kostelecky
:::
...
-   0800 - 0900 DS/KS pack CBL truck (2017 Silverado) at Solomons, MD. Drive to Harry S Truman Park and Ride.
    -   200 Harry S. Truman Pkwy, Annapolis, MD 21401
-   1015 - 1230 DS/KS picks up EK. Drive to MD Coastal Bays Program office.
...
-   1300 - 1330 Unload pots. BH/mate begin loading pots onto vessel.
-   1330 - 1530 DS/KS/EK drive to MD Coastal Bays Program. Repeat pot loading/return/unloading.
-   1530 - 1600 Drop trailer off at MDCBP. Return to W Ocean City.
-   1600 Check into Microtel
...
-   Select four sites to deploy ropeless gear based on packing of vessel and weather
-   Attach HOBO loggers (2) to ropeless cages
...
-   `r format(deploy_seq$endtime[1], '%H:%M')` Arrive **`r deploy_seq$end[1]`**. Deploy pots with ropeless recovery system.
...
-   `r format(deploy_seq$endtime[2], '%H:%M')` Arrive **`r deploy_seq$end[2]`**. Deploy pots with ropeless recovery system.
