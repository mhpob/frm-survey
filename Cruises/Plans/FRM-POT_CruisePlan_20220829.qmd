---
title: 'Pot Survey -- Shakedown September 2022'
subtitle: "August 29 - Sept 1, 2022   *F/V Integrity*   West Ocean City, MD"
format: html
editor: visual
echo: false
message: false
...
params:
  ...
  seed: 20220901
  vessel_sp_kts: 8
  d1_start: '2022-08-30 02:30'
  d2_start: '2022-09-01 02:30'
---
...
ctrl_sites <- ctrl_area |> 
  ...
  st_as_sf() |> 
  st_transform(4326) |>
  DT(, station := paste(substr(params$seed, 3, 6),
                        1:params$n_control,
                        sep = '_')) 
