---
title: 'Pot Survey -- "September" 2023'
subtitle: "October 3 - 5, 2023   *F/V Integrity*   West Ocean City, MD"
format: html
editor: visual
echo: false
message: false
...
-   Scientific crew (`r paste(umces_initials, collapse = ', ')`)
    -   14:00 - 15:00 `r paste(umces_initials, collapse = '/')` pack CBL van (2017 Caravan) at Solomons, MD. Drive to Microtel West Ocean City.
