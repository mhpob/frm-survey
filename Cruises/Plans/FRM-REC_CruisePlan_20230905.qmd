---
title: 'Recreational Survey -- September 2023'
subtitle: "September 5-7, 2023   [*F/V Fin Chaser*](https://finchasersportfishing.com/)   Ocean City, MD"
format: html
editor: visual
echo: false
message: false
...
::: columns
::: {.column width="50%"}
-   `r format(survey_seq[[2]]$sttime[1] - 30 * 60, '%H:%M')`: DHS, KS, DW meet at Talbot St Pier, load gear onto *F/V Fin Chaser*
...
-   `r format(survey_seq[[2]]$endtime[1] + 5*60, '%H:%M')`: Mate begins jigging. Scientific crew deploys CTD.
...
-   `r format(survey_seq[[2]]$endtime[2] + 5*60, '%H:%M')`: Mate begins jigging. Scientific crew deploys CTD.
