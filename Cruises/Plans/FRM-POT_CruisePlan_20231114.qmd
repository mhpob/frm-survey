---
title: 'Pot Survey -- November 2023'
subtitle: "November 14 - 16, 2023   *F/V Integrity*   West Ocean City, MD"
format: html
editor: visual
echo: false
message: false
...
exp_sites <- turbines |>
  DT(grepl('-1\\d$', name) & location == 'inner') |>
  DT(sample(.N, params$n_exp)) |>
  DT(, .(station = name, geometry = geom)) |>
  st_as_sf()
