---
title: 'Recreational Survey -- June 2023'
subtitle: "June 12 -14, 2023   [*F/V Fin Chaser*](https://finchasersportfishing.com/)   Ocean City, MD"
format: html
editor: visual
echo: false
message: false
...
-   [Jamie Testa](mailto:jctesta@umces.edu): 315-382-2579
...
-   Scientific crew (MOB, JT)
    ...
    -   Drop off fish pots at Maryland Coastal Bays Program

### `r format(as.POSIXct(params$start$d1), '%d %B')`

-   Full crew (MOB, JT, TS, DS, mate)
