castaway_clean <- function(pot_data, rec_data){
  ...
  ctd_import <- function(x) {
    ...
    # Hack the second October 2023 cruise and Early-spring 2024 codes
    ctd[, cruise := fifelse(grepl('20231025', file_name), '2310-2', cruise)]
    ctd[, cruise := fifelse(grepl('20240501', file_name), '2404', cruise)]
